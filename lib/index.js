...
var URLS = (0, _conf.getUrls)({}); /* eslint-disable no-console,quote-props,no-constant-condition,prefer-template,consistent-return */
...
var WeixinBot = function (_EventEmitter) {
  ...
  function WeixinBot() {
    ...
    _this.contactList = [];
    _this.groupList = [];
    _this.groupMemeberList = [];
    _this.brandList = []; // 公众帐号
    _this.spList = []; // 特殊帐号
  ...
  (0, _createClass3.default)(WeixinBot, [{
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 14:
                loginCode = parseInt(result.match(/code=(\d{3});/)[1], 10);
                _context3.t1 = loginCode;
                _context3.next = _context3.t1 === 200 ? 18 : _context3.t1 === 201 ? 23 : _context3.t1 === 408 ? 24 : 26;
                break;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 12:
                ...
                result.AddMsgList.forEach(function (msg) {
                  return _this3.handleMsg(msg);
                });
    ...
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6() {
        var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, host, result, retcode;
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 18:
                retcode = result.match(/retcode:"(\d+)"/)[1];
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 11:
                retcode = result.match(/retcode:"(\d+)"/)[1];
                selector = result.match(/selector:"(\d+)"/)[1];
    ...
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10() {
        var result, skeyM, wxsidM, wxuinM, passTicketM;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 13:
                ...
                skeyM = result.match(/<skey>(.*)<\/skey>/);
                wxsidM = result.match(/<wxsid>(.*)<\/wxsid>/);
                wxuinM = result.match(/<wxuin>(.*)<\/wxuin>/);
                passTicketM = result.match(/<pass_ticket>(.*)<\/pass_ticket>/);
              ...
              case 14:
                ...
                this.memberList.forEach(function (member) {
                  ...
                  if (member.VerifyFlag & _conf.CODES.MM_USERATTRVERIFYFALG_BIZ_BRAND) {
                    _this4.brandList.push(member);
                    return;
                  }

                  if (spAccounts.includes(userName) || /@qqim$/.test(userName)) {
                    _this4.spList.push(member);
                    return;
                  }

                  if (userName.includes('@@')) {
                    _this4.groupList.push(member);
                    return;
                  }

                  if (userName !== _this4.my.UserName) {
                    _this4.contactList.push(member);
                  }
                });
    ...
    value: function () {
      ...
      return function fetchBatchgetContact() {
        return ref.apply(this, arguments);
      };
    }()
  }, {
    key: 'handleMsg',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(msg) {
    ...
    key: 'sendText',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(to, content) {
        var clientMsgId, result;
        return _regenerator2.default.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                clientMsgId = (+new Date() + Math.random().toFixed(3)).replace('.', '');
                result = undefined;
                _context14.prev = 2;
                _context14.next = 5;
                return rp({
