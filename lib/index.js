...
var WeixinBot = function (_EventEmitter) {
  ...
  function WeixinBot() {
    ...
    _this.GroupMembers.ensureIndex({ fieldName: 'UserName', unique: true });
  ...
  (0, _createClass3.default)(WeixinBot, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 47:
                ...
                debug('main step occur error', _context.t2);
                // retry login
                this.run();
                return _context.abrupt('return');
              ...
              case 14:
                ...
                data.MemberList.forEach(function (member) {
                  ...
                  if (member.VerifyFlag & _conf.CODES.MM_USERATTRVERIFYFALG_BIZ_BRAND) {
                    _this4.Brands.insert(member);
                    return;
                  }

                  if (spAccounts.includes(userName) || /@qqim$/.test(userName)) {
                    _this4.SPs.insert(member);
                    return;
                  }

                  if (userName.includes('@@')) {
                    _this4.Groups.insert(member);
                    return;
                  }

                  if (userName !== _this4.my.UserName) {
                    _this4.Contacts.insert(member);
                  }
                });
    ...
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(groupId) {
        var data, Group, MemberList;
    ...
    key: 'getMember',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(id, groupId) {
        var member;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 5:
                ...
                _context13.next = 8;
                return this.fetchBatchgetContact(id);
      ...
      return function getMember(_x3, _x4) {
        return ref.apply(this, arguments);
      };
    }()
  }, {
        ...
        return _regenerator2.default.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.next = 2;
                return this.Groups.findOneAsync({ UserName: id });
    ...
    key: 'handleMsg',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(msg) {
        var userId;
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                _context15.next = 4;
                return this.getMember(userId, msg.FromUserName);

              case 4:
                msg.Member = _context15.sent;
                _context15.next = 7;
                return this.getGroup(msg.FromUserName);

              case 7:
                msg.Group = _context15.sent;
