...
var WeixinBot = function (_EventEmitter) {
  ...
  (0, _createClass3.default)(WeixinBot, [{
    ...
    key: 'getMember',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(id) {
        var member;
    ...
    key: 'getGroupMember',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(id, groupId) {
        var member;
    ...
    key: 'handleMsg',
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(msg) {
        var userId;
        return _regenerator2.default.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 4:
                msg.Member = _context16.sent;
                _context16.next = 7;
                return this.getGroup(msg.FromUserName);

              case 7:
                msg.Group = _context16.sent;
